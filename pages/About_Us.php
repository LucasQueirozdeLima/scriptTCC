...
<head>
    ...
    <style>
        ...
        .content h2 {
            color: #333333; /* Tom de preto suavizado */
            font-size: 24px;
            margin-bottom: 20px;
        }
        .content p {
        ...
        .team {
            ...
            padding: 50px 20px;
            text-align: center; /* Centralizando o conteúdo da equipe */
        }
        .team h2 {
            color: #333333; /* Tom de preto suavizado */
            font-size: 24px;
...
<body>
    <header>
        <img class="img_logo" alt="Logo da Empresa" height="50" src="../estilizacao/images/logo_nav.png" width="200"/>
    </header>
    ...
    <div class="team">
        ...
        <div class="team-members">
            <div class="team-member">
                <img alt="a" height="100" src="../estilizacao/images/a.jpeg" width="100"/>
            ...
            <div class="team-member">
                <img alt="b" height="100" src="../estilizacao/images/b.jpeg" width="100"/>
            ...
            <div class="team-member">
                <img alt="a" height="100" src="../estilizacao/images/c.jpeg" width="100"/>
                <p>Gabriel Silva </p>
                <a href="https://github.com/kimkimdev"><img class="logoGit" src="../estilizacao/images/GitHub-logo.png" alt="Logo github">kimkimdev</a>
            </div>
            <div class="team-member">
                <img alt="a" height="100" src="../estilizacao/images/d.jpeg" width="100"/>
            ...
            <div class="team-member">
                <img alt="a" height="100" src="../estilizacao/images/e.jpeg" width="100"/>
